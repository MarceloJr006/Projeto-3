...
<body>
    ...
    <!-- Carousel wrapper -->
    <center>
        <h1 class="fonteNoticia">About the site</h1>
        
        <p>
        PlayMovie is a site made for you to read about news of your favorite movies and upcoming releases,
        this site was created as a project.
        </p>
        <img src="../img/gosto-filmes-profissao-1.png" alt="">
        <h1>Creator</h1>
        <p>
        The creator of this site is Marcelo Ap. Malvezi Junior and lives in the city of Taquaritinga,
            he takes the course System for the internet.
        </p>
    </center>

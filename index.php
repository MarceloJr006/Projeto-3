...
<body>
        ...
        <div class="carousel-inner" style="height:600px; ">
            ...
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <h5>Cruella</h5>
                    <p>Cruella 2, baseado em 101 Dálmatas, já está em desenvolvimento na Disney</p>
                </div>
            </div>
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <h5>Assalto ao Banco da Espanha</h5>
                    <p>Thom Laybrick é um brilhante engenheiro sedento por desafios. O negociador de arte Walter conhece bem o talento de Thom e o convence a participar de um roubo ao Banco da Espanha que parece ser impossível.</p>
                </div>
            </div>
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <h5>Awake</h5>
                    <p>Awake é um thriller americano de ficção científica de 2021, dirigido por Mark Raso, a partir de um roteiro que ele escreveu ao lado de Joseph Raso.</p>
                </div>
            </div>
        </div>
        <!-- Inner -->
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="card-text">
            Cruella 2, baseado em 101 Dálmatas, já está em desenvolvimento na Disney
            </p>
            <a href="Paginas/noticia1.php" class="btn btn-primary">Ver mais</a>
        </div>
    </div>
    <div class="card">
        ...
        <div class="card-body">
            <h5 class="card-title">Assalto ao Banco da Espanha</h5>
            <p class="card-text">
            Thom Laybrick é um brilhante engenheiro sedento por desafios. 
            </p>
            <a href="Paginas/noticia2.php" class="btn btn-primary">Ver mais</a>
        </div>
    </div>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="card-text">
            Awake é um thriller americano de ficção científica de 2021.
            </p>
            <a href="Paginas/noticia3.php" class="btn btn-primary">Ver mais</a>
        </div>
    </div>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="card-text">
            O quarto filme da franquia Hotel Transivânia 4
            </p>
            <a href="Paginas/noticia4.php" class="btn btn-primary">Ver mais</a>
        </div>
    </div>
    <div class="card">
        <img src="https://i.ytimg.com/vi/3DIFnZeJiO8/maxresdefault.jpg" class="card-img-top" alt="..." />
        <div class="card-body">
            <h5 class="card-title">O Homem nas Trevas 2</h5>
            <p class="card-text">
            O Homem nas Trevas (Don't Breathe) vai ganhar uma continuação
            </p>
            <a href="Paginas/noticia5.php" class="btn btn-primary">Ver mais</a>
        </div>
    </div>
    <div class="card">
        <img src="https://todosnegrosdomundo.com.br/wp-content/uploads/2020/07/candyman.jpg" class="card-img-top" alt="..." />
        <div class="card-body">
            <h5 class="card-title">A Lenda de Candyman tem estreia adiada novamente</h5>
            <p class="card-text">
            Por conta da pandemia, o filme foi adiada novamente.
            </p>
            <a href="Paginas/noticia6.php" class="btn btn-primary">Ver mais</a>
    </div>
</div>
